...
**
** Created: Sun Nov 10 18:49:07 2013
...
void EmulWin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        EmulWin *_t = static_cast<EmulWin *>(_o);
        switch (_id) {
...
const QMetaObjectExtraData EmulWin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EmulWin::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_EmulWin,
      qt_meta_data_EmulWin, &staticMetaObjectExtraData }
};

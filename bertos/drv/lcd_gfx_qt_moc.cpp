...
void EmulLCD::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObjectExtraData EmulLCD::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject EmulLCD::staticMetaObject = {
    { &QFrame::staticMetaObject, qt_meta_stringdata_EmulLCD,
      qt_meta_data_EmulLCD, &staticMetaObjectExtraData }
};

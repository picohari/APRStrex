...
#define APP_NAME 		"APRStrex"
#define APP_DESCRIPTION "APRS Tracker & BOSCH KF163"
#define APP_AUTHOR 		"DK6YF"
#define APP_COPYRIGHT 	"Copyright 2016 H9-Laboratory Ltd. (http://labor.h9l.net/)"
#define APP_OS 			"BeRTOS 2.7.99"


#if (ARCH & ARCH_DEFAULT) | ARCH_EMUL
	#define VERS_MAJOR 0
	#define VERS_MINOR 2
	#define VERS_REV   8
	#define VERS_LETTER "c"
...
#ifdef _SNAPSHOT
	#define VERS_TAG "snapshot" " " __DATE__ " " __TIME__ " - "  MAKE_VERS(VERS_MAJOR,VERS_MINOR,VERS_REV)
#else

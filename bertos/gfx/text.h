...
void text_xywrap(struct Bitmap *bm, coord_t x, coord_t y, const char *s, int lineSize /*, const char *prefix*/);
...
void text_xywrap_P(struct Bitmap *bm, coord_t x, coord_t y, const char *s, int lineSize /*, const char *prefix*/);
#endif /* CPU_HARVARD */

...
extern const struct MenuItem *current_menu_item;
extern const struct Menu *current_menu;
...
//#define MIF_RETURN       	BV(6) /**< Toggle MIF_RETURN when item is selected */
#define MIF_EDITABLE       	BV(7)  /**< Item can be edited through external display function */
...
#define MIF_RENDERHOOK      BV(14) /**< Render a menu item inside a menu */
#define MIF_SHOWSCREEN      BV(15) /**< Show external screen inside a menu item, points to external display function  */
...
#define TEMP_OIL			0
#define VOLT_BATTERY 	 	1
#define RPM_ENGINE   	 	2
#define PRESS_BAROMETRIC	3
#define LEVEL_FUELTANK 		4
#define SPEED_VEHICLE	 	5
#define AMPS_CHARGER	 	6
#define POWER_TX 			7
